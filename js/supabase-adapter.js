    ...
    async handleGet(tableName, recordId, originalUrl) {
        try {
            ...
            if (recordId) {
                ...
                // Supabaseクエリ構築（新しい順にソート）
                supabaseUrl += `?select=*&order=created_at.desc&limit=${limit}&offset=${offset}`;
                ...
                console.log(`📊 Supabaseクエリ: テーブル=${tableName}, limit=${limit}, offset=${offset}, order=created_at.desc`);
